...
export const translationEnglish: Translation = {
  ...
  Learn: "Learn",
  Clear: "Clear",
  ClearTile: "Clear Custom list",
  ClearConfirm: "Are you sure you want to clear your Custom list?",
  Create: "Create",
  Copy: "Copy",
  CopyTile: "Copy to Custom list",
  CopyConfirm:
...
export const translationFrench: Translation = {
  ...
  Create: "Créer",
  Copy: "Copier",
  CopyTile: "Copier vers la liste personnalisée",
  CopyConfirm:
